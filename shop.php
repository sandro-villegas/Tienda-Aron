							...
							<div class="mainmenu d-lg-block d-none">
								<nav>
									<ul>
										...
										<li class="hot"><a href="shop.html">Tienda</a></li>
										<li class="new"><a href="shop-list.html">Contactenos</a></li>																									
									</ul>
								</nav>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-3">
						...
						<div class="accordion_one">
							<h4><a class="accordion-trigger" data-bs-toggle="collapse" href="#divone">Color</a></h4>
							...
							<h4><a class="accordion-trigger" data-bs-toggle="collapse" href="#div2">manufacture</a></h4>
							...
							<h4><a class="accordion-trigger" data-bs-toggle="collapse" href="#div3">Size</a></h4>
																	...
																	<div class="product-action">
																		<div class="button-group">
																			...
																			<div class="product-button-2">
																				...
																				<a href="#" class="modal-view" data-bs-toggle="modal" data-bs-target="#productModal" title="Quickview"><i class="fa fa-search-plus"></i></a>
																			</div>
																		</div>
																	</div>
																</div>
			...
			<div class="brand-logo-area carosel-navigation">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="area-title">
								<h3 class="title-group border-red gfont-1">Marcas que trabajamos</h3>
							</div>
						</div>
					</div>
                    <div class="row">
                        <div class="active-brand-logo owl-carousel marcas">
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-4 col-md-6 col-12">
							<div class="social-media" id="img_Logo">
								<a href="#" class="iconredes"><i class="fa fa-facebook fb"></i></a>
								<a href="" class="iconredes"><i class="fa fa-google-plus gp"></i></a>
								<a href="" class="iconredes"><i class="fa fa-twitter tt"></i></a>
								<a href="" class="iconredes"><i class="fa fa-youtube yt"></i></a>
								<a href="" class="iconredes"><i class="fa fa-linkedin li"></i></a>
								<a href="" class="iconredes"><i class="fa fa-rss rs"></i></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-12 col-md-6 col-lg-3">
							...
							<nav>
								<ul class="footer-content">
									...
									<li><a href="#">Vale regalo</a></li>
									<li><a href="#">Afiliados</a></li>
									<li><a href="shop-list.php">Especiales</a></li>
									<li><a href="#">Términos de búsqueda</a></li>
								</ul>
							</nav>
						</div>
						<div class="col-12 col-md-6 col-lg-3">
							...
							<nav>
								<ul class="footer-content box-information">
									<li>
										<i class="fa fa-home"></i><span id="Direcion"></span>
									</li>
									<li>
										<i class="fa fa-envelope-o"></i><p><a href="contact.php" id="gmail-contacto"></a></p>
									</li>
									<li>
										<i class="fa fa-phone"></i>
										<span id="number_of_cellphone"></span>
								</ul>
							</nav>
						</div>
					</div>
